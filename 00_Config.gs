...
const CODE_VERSION   = 18.0; // 2026-06-12: AUDIT D — single-day packaging expenses now exclude cancelled orders (matches range variant); rest of kitchen/delivery audited clean
