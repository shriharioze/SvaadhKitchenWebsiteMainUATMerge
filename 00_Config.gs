...
const CODE_VERSION   = 17.9; // 2026-06-12: AUDIT B4-B6 — markRefunded idempotency+lock (no double credit), verify-time clawback dynamic threshold + ₹11 delivery, markCustomersPaid date normalize
