...
const CODE_VERSION   = 15.1; // 2026-06-06: dup-const compile fix; webhook failure→Failed; submitOrder server-verifies gateway payment (never trusts client "Paid"); attendance payroll module
